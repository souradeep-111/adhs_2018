...
int main(int argc , char ** argv)
{
	...
	// char controller_file[] = "./network_files/control_ex_13_2d/neural_network_information_sample" ;
  ...
  // Reachability testing of closed loop network with directions
	if (produce_reachable_sets)
	{
		...
		char controller_file[] = "./network_files/control_ex_13_2d/modified_controller" ;
	...
	if (simulate_system)
	{
		...
		unsigned int no_of_plots = 5;
		vector< vector< datatype > > range_now(2, vector< datatype >(2));
		range_now[0][0] = 0.7;  range_now[0][1] = 0.75;
		range_now[1][0] = 0.8; range_now[1][1] = 0.85;
	...
	// char nix[] = "./network_files/neural_network_controller";

	// network_handler controller_network(nix);
	// vector< vector< vector< datatype > > > weights;
	// vector< vector< datatype > > all_biases;
	//
	// controller_network.return_network_information(weights, all_biases);
	//
	// unsigned int i, j, k, output_neurons, inputs ;
	//
	...
	// biases  = all_biases[0];
	//
	// vector< datatype > offset(2,0);
	// offset[0] = 0.01;
	// offset[1] = 0.0;
	//
	// inputs = (weight_matrix[0]).size();
	// output_neurons = (weight_matrix).size();
	//
	//
	// if(biases.size() != output_neurons){cout << "Ooops " << endl;}
	//
	// datatype adjust;
	//
	// i = 0;
	...
	// {
	// 	adjust = weight_matrix[i][0] * offset[0] ;
	// 	adjust += weight_matrix[i][1] * offset[1] ;
	// 	biases[i] += adjust;
	// 	i++;
	// }
	//
	// all_biases[0] = biases;
	//
	// controller_network.update_information(weights, all_biases);
	// char name[] = "./network_files/modified_controller";
	// write_network_to_file(weights, all_biases, name);
