...
int main(int argc , char ** argv)
{
  ...
  sherlock_parameters.MILP_e_tolerance = 1e-6;
	...
	if(produce_reachable_sets)
	{
		...
		char controller_file[] = "./network_files//control_ex_15_3d/neural_network_controller" ;
  ...
  steps = system_plots.reach_set_time_range;
	...
	if (simulate_system)
	{
		...
		range_now[0][0] = 0.4;  range_now[0][1] = 0.45;
		range_now[1][0] = -0.35; range_now[1][1] = -0.3;
		range_now[2][0] = -0.4;  range_now[2][1] = -0.35;
